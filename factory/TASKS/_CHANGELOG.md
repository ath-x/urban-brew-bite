...
## v8.0.0-alpha (2026-03-01)\n- NEW: v33 Sync Bridge protocol between Dock and Site.\n- NEW: Server-side Data Aggregation (all_data.json).\n- NEW: Universal Batch Save with CORS security.
